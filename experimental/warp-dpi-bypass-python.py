...
def run_command(command, require_sudo=False):
    try:
        ...
        print(f"HATA: Komut başarısız: {' '.join(command)}")
        sys.exit(1)

# 1. Cloudflare WARP yüklü mü kontrol et
...
# 2. systemd-resolved durdur ve maskelen
...
# 3. warp-svc servisini etkinleştir ve başlat
